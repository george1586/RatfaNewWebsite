...
export const faqData = [
    { q: "When will Steelgate ship?", a: "We're targeting Q4 2026. Pre-ordering now locks in your founding price and reserves your spot. We'll keep you updated as production progresses — you'll hear from us before anyone else." },
    { q: "What if I change my mind? Can I cancel my pre-order?", a: "Yes. Your €45 Orderpayment is fully refundable before we ship. Just email us and we'll process the refund within a few days. No questions asked." },
    { q: "Why should I Orderinstead of waiting for the full launch?", a: "Founding customers get Steelgate at €45 — permanently lower than the launch price. Pre-ordering is the only way to lock in the founding rate." },
    ...
    { q: "What happens if you don't reach 100 pre-orders?", a: "If we don't hit the minimum needed to move to production, every Orderwill be fully refunded. You won't lose anything." },
