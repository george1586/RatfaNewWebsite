...
export const faqData = [
    ...
    { q: "What if I change my mind? Can I cancel my pre-order?", a: "Yes. Your €45 pre-order payment is fully refundable before we ship. Just email us and we'll process the refund within a few days. No questions asked." },
    { q: "Why should I pre-order instead of waiting for the full launch?", a: "Founding customers get Steelgate at €45 — permanently lower than the launch price. Pre-ordering is the only way to lock in the founding rate." },
